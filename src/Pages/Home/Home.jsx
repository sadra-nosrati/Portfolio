      ...
      >
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-4 mobile:px-6 tablet-portrait:px-8">
          <div className="max-w-xl text-right mobile-landscape:max-w-2xl tablet-landscape:max-w-3xl">
            <p className="mb-4 inline text-sm font-medium text-secondary bg-secondary/30 px-4 py-1 rounded-sm mobile:text-base tablet-portrait:text-lg">
            ...
            <div className="flex flex-col gap-3 mobile:flex-row mobile:justify-start">
              <a
                href="#projects"
                className="rounded-xl bg-secondary px-7 py-3 text-center text-sm font-medium text-white transition hover:bg-accent mobile:px-8"
              >
                مشاهده پروژه‌ها
              </a>
