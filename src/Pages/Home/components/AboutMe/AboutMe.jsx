...
function AboutMe() {
  return (
    <section
      ...
      className="py-10 tablet-portrait:py-14 tablet-landscape:py-20 laptop:py-25"
    >
      <div className="w-full px-4 tablet-portrait:px-6">
        <div className="mx-auto flex max-w-7xl flex-col items-center gap-5 tablet-landscape:flex-row tablet-landscape:items-center tablet-landscape:gap-9 laptop:gap-15">
          <AboutImage />
