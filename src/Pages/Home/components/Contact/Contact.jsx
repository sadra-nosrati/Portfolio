...
function Contact() {
  return (
    <section id="contact" aria-labelledby="contact-title" className="py-15">
            ...
            <address className="mt-12 not-italic">
              <div className="grid gap-5 tablet-portrait:grid-cols-2">
                ...
                >
                  ...
                  <strong
                    dir="ltr"
                    className="mt-3 block text-left text-xl tracking-wider text-white transition-colors duration-300 group-hover:text-secondary"
                  >
                    0912 088 1682
                  </strong>
                </a>
